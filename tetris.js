...
// Ces constantes définissent la position initiale des pièces lorsqu'elles apparaissent en haut du plateau.
//START_X définit l'endroit où la pièce commence horizontalement (de gauche à droite).
//BOARD_WIDTH = 10 → Il y a 10 colonnes sur le plateau.
//Math.floor(BOARD_WIDTH / 2) → Cela nous donne le milieu du plateau :
//Math.floor(10 / 2) = Math.floor(5) = 5
//On soustrait 1 pour mieux centrer la pièce, car certaines pièces (comme O, T, L, J) ont plusieurs blocs et doivent être ajustées.
